...
/**
 * VaaniActiveLeadSearch represents the model behind the search form of `common\models\VaaniActiveLead`.
 */
class VaaniActiveLeadSearch extends VaaniActiveLead
{
    /**
     * {@inheritdoc}
     */
