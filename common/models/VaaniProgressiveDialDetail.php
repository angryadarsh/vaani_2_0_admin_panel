...
/**
 * This is the model class for table "vaani_progressive_dial_detail".
 *
 * @property int $id
 ...
 */
class VaaniProgressiveDialDetail extends \yii\db\ActiveRecord
{
    /**
     * {@inheritdoc}
     */
    ...
    {
        return 'vaani_progressive_dial_detail';
    }
