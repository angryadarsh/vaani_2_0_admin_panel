            ...
            <div class="row">
                ...
                <div class="col-9">
                    <div class="tab-content" id="myTabContent">   
                        <div class="tab-pane kp_content" style="display:block;" role="tabpanel"  aria-labelledby="" >
...
<?php
$this->registerCss("
#resolte-contaniner{width: 100%; height:70vh; overflow: auto;}
.nodata{ display: flex;justify-content: center;height: 70vh;align-items: center;background-color: #e9e9e9; }
      ...
      if(ext == 'xlsx'){
           ...
           //display excel
                ...
                if (info==0) {
                    $('#'+id).each(function() {
                        $(this).hide();
                        $('#resolte-contaniner').html('<div class="nodata"><h3>No Data Found</h3></div>');
                    });
                }
        }
        else{
  ...
  //universal searching on keypress
    ...
    $('#universal-search').on( 'keyup keypress', function (e){
        ...
        $('.isexcel').each(function(){
            ...
            $('.kp_tabs').removeClass('active');
            $('.isexcel[style*="display: block"]:first').addClass('active');
        }); 
                ...
                $.ajax({
                            ...
                            listdata += '<a href="#" class="list list-group-item list-group-item-action">No data found</a>';
                                ...
                                if(e.key === "Enter"){
                                    ...
                                    //record display which is 0
                                    //record display which is more than 1
                                        $.ajax({
                                            method: 'POST',
                                            url: '<?php echo $urlManager->baseUrl ?>/index.php/kp/suggestion',
...
$("#universal-search").on('keyup keydown',function(e) {
    if(e.which == 13) {
        $('.universal-search-list').css('display','none');
    }
});
