...
// echo"<pre>";print_r($qms_names);exit;
$this->registerJs("
$('.dataTable').DataTable( {} );
");
// kp tabs fetch
            ...
            <div class="tab-content" id="tabs-tabContent">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="row form-group">
                                            ...
                                            <div class=" col-sm-8">
                                                <?= $form->field($model, 'campaign_name', ['template' => '{input}{label}{error}{hint}'])->textInput(['placeholder' => 'Campaign Name'])->label(false) ?>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                    ...
                                    <!-- <div class="col-lg-6" id="TimePreview">
                                        <div class="row form-group">
                                            <label class="form-label col-sm-4" for="edascampaign-time_preview">Time Preview</label>
                                            <div class="col-sm-8">
                                    ...
                                    <div class="col-lg-12 form-group text-center btnGroup">
                                        ...
                                        <button type="button" class="btn btn-outline-primary form_loader skip-next-next generalnext" id="generalnext" value="Submit">Next</button>
                                        <button type="button" class="btn btn-outline-primary form_loader saveCurrentForm  generalnext" >Next</button>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="skillList">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 form-group text-center btnGroup mb-0">
                                ...
                                <button type="button" class="btn btn-outline-primary form_loader saveCurrentForm tab_skill" id="tab_skill">Next</button>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="tab-pane" id="tabs-queues" role="tabpanel" aria-labelledby="tabs-queues-tab">
                    <div class="queues_list" id="queuesList">
                        ...
                        <div class="col-lg-12 form-group text-center btnGroup mt-15 mb-0">
                            ...
                            <button type="button" class="btn btn-outline-primary form_loader saveCurrentForm add_queues" id="add_queues">Next</button>
                        </div>
                    </div>
                </div>
                <!-- Queue Tab - End -->
                ...
                <div class="tab-pane" id="tabs-disposition" role="tabpanel" aria-labelledby="tabs-disposition-tab">
                        ...
                        <div class="clearfix mb-3 top-heading">
                            ...
                            <div class="float-right selectBox d-flex">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6">
                                        <?= $form->field($model, 'disposition_plan_id', ['template' => '{input}{label}{error}{hint}'])->dropdownList($disposition_plans, ['prompt' => 'Select...', 'class' => 'disposition_plan form-control', 'value' => isset($model->disposition_plan_id) ? User::encrypt_data($model->disposition_plan_id) : null ])->label(false) ?>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-12 form-group text-center btnGroup mb-0 pt-3">
                        ...
                        <button type="button" id="dispositionTab" class="btn btn-outline-primary form_loader saveCurrentForm dispositionTab">Next</button>
                    </div>
                </div>
                            ...
                            <div class="col-lg-7">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group row">
                                        ...
                                        <div class="col-lg-8">
                                            <?php $model->callAccess['is_manual'] == 1 ? $manual="true" : $manual="false" ?>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-8">
                                    <?php $model->callAccess['is_conference'] ==1 ? $is_conference="true" : $is_conference="false" ?>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-8">
                                        <?php $model->callAccess['is_transfer'] ==1 ? $is_transfer="true" : $is_transfer="false" ?>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="col-lg-8">
                                        <?php $model->callAccess['is_consult'] ==1 ? $is_consult="true" : $is_consult="false" ?>
                                ...
                                <div class="col-lg-12 form-group text-center btnGroup mb-0">
                                    ...
                                    <button type="reset" class="btn btn-outline-secondary">Reset</button>
                                    <button type="button" id="add_agents" class="btn btn-outline-primary form_loader next add_agents">Next</button>
                                    <button type="button" id="add_agents" class="btn btn-outline-primary form_loader saveCurrentForm add_agents">Next</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                ...
                                <div class="col-lg-12 form-group text-center btnGroup mb-0">
                                    ...
                                    <button type="button" id="add_dailer" class="btn btn-outline-primary form_loader saveCurrentForm add_dailer">Next</button>
                                </div>
                            </div>
                        </div>
                    </div>
