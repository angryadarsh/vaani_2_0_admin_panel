...
--
-- Table structure for table `vaani_predictive_action_history`
--

DROP TABLE IF EXISTS `vaani_predictive_action_history`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vaani_predictive_action_history` (
...
--
-- Dumping data for table `vaani_predictive_action_history`
--

LOCK TABLES `vaani_predictive_action_history` WRITE;
/*!40000 ALTER TABLE `vaani_predictive_action_history` DISABLE KEYS */;
/*!40000 ALTER TABLE `vaani_predictive_action_history` ENABLE KEYS */;
UNLOCK TABLES;
