...
--
-- Table structure for table `vaani_preview_dial_detail`
--

DROP TABLE IF EXISTS `vaani_preview_dial_detail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vaani_preview_dial_detail` (
...
--
-- Dumping data for table `vaani_preview_dial_detail`
--

LOCK TABLES `vaani_preview_dial_detail` WRITE;
/*!40000 ALTER TABLE `vaani_preview_dial_detail` DISABLE KEYS */;
/*!40000 ALTER TABLE `vaani_preview_dial_detail` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-11-30 10:45:10
