...
--
-- Table structure for table `vaani_dynamic_crm_data`
--

DROP TABLE IF EXISTS `vaani_dynamic_crm_data`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vaani_dynamic_crm_data` (
...
--
-- Dumping data for table `vaani_dynamic_crm_data`
--

LOCK TABLES `vaani_dynamic_crm_data` WRITE;
/*!40000 ALTER TABLE `vaani_dynamic_crm_data` DISABLE KEYS */;
/*!40000 ALTER TABLE `vaani_dynamic_crm_data` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-11-30 10:45:27
