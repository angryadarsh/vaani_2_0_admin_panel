...
CREATE TABLE `vaani_call_recordings` (
  `id` int(11) NOT NULL,
  `unique_id` varchar(180) DEFAULT NULL,
  `start_time` varchar(180) DEFAULT NULL,
  `duration` varchar(180) DEFAULT NULL,
  `agent_id` varchar(180) DEFAULT NULL,
  `customer_number` varchar(180) DEFAULT NULL,
  `campaign` varchar(200) DEFAULT NULL,
  `queue` varchar(200) DEFAULT NULL,
  `recording_path` varchar(720) DEFAULT NULL,
  `type` int(11) DEFAULT NULL,
  `end_time` varchar(180) DEFAULT NULL,
  PRIMARY KEY (`id`)
