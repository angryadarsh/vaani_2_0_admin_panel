...
--
-- Table structure for table `vaani_crm_lead_mapping`
--

DROP TABLE IF EXISTS `vaani_crm_lead_mapping`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vaani_crm_lead_mapping` (
...
--
-- Dumping data for table `vaani_crm_lead_mapping`
--

LOCK TABLES `vaani_crm_lead_mapping` WRITE;
/*!40000 ALTER TABLE `vaani_crm_lead_mapping` DISABLE KEYS */;
/*!40000 ALTER TABLE `vaani_crm_lead_mapping` ENABLE KEYS */;
UNLOCK TABLES;
