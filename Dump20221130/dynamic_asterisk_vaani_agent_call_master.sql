...
--
-- Table structure for table `vaani_agent_call_master`
--

DROP TABLE IF EXISTS `vaani_agent_call_master`;
...
--
-- Dumping data for table `vaani_agent_call_master`
--

LOCK TABLES `vaani_agent_call_master` WRITE;
/*!40000 ALTER TABLE `vaani_agent_call_master` DISABLE KEYS */;
/*!40000 ALTER TABLE `vaani_agent_call_master` ENABLE KEYS */;
UNLOCK TABLES;
