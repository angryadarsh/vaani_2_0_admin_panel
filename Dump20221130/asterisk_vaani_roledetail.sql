...
--
-- Table structure for table `vaani_roledetail`
--

DROP TABLE IF EXISTS `vaani_roledetail`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vaani_roledetail` (
...
--
-- Dumping data for table `vaani_roledetail`
--

LOCK TABLES `vaani_roledetail` WRITE;
/*!40000 ALTER TABLE `vaani_roledetail` DISABLE KEYS */;
/*!40000 ALTER TABLE `vaani_roledetail` ENABLE KEYS */;
UNLOCK TABLES;
