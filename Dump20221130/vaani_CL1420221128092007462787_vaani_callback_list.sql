...
--
-- Table structure for table `vaani_callback_list`
--

DROP TABLE IF EXISTS `vaani_callback_list`;
...
--
-- Dumping data for table `vaani_callback_list`
--

LOCK TABLES `vaani_callback_list` WRITE;
/*!40000 ALTER TABLE `vaani_callback_list` DISABLE KEYS */;
INSERT INTO `vaani_callback_list` VALUES (1,'','11005','1669718596.172','1669718596.172',NULL,'9664334674',2,'2022-11-29 16:15:18','2022-11-29 16:15:19','2022-11-29 16:14:01',NULL,1,1);
/*!40000 ALTER TABLE `vaani_callback_list` ENABLE KEYS */;
UNLOCK TABLES;
