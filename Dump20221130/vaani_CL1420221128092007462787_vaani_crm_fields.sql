...
--
-- Table structure for table `vaani_crm_fields`
--

DROP TABLE IF EXISTS `vaani_crm_fields`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vaani_crm_fields` (
...
--
-- Dumping data for table `vaani_crm_fields`
--

LOCK TABLES `vaani_crm_fields` WRITE;
/*!40000 ALTER TABLE `vaani_crm_fields` DISABLE KEYS */;
/*!40000 ALTER TABLE `vaani_crm_fields` ENABLE KEYS */;
UNLOCK TABLES;
