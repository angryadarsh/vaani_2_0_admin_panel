...
--
-- Table structure for table `vaani_outbound`
--

DROP TABLE IF EXISTS `vaani_outbound`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vaani_outbound` (
...
--
-- Dumping data for table `vaani_outbound`
--

LOCK TABLES `vaani_outbound` WRITE;
/*!40000 ALTER TABLE `vaani_outbound` DISABLE KEYS */;
/*!40000 ALTER TABLE `vaani_outbound` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-11-30 10:45:26
