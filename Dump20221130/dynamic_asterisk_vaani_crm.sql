...
--
-- Table structure for table `vaani_crm`
--

DROP TABLE IF EXISTS `vaani_crm`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `vaani_crm` (
...
--
-- Dumping data for table `vaani_crm`
--

LOCK TABLES `vaani_crm` WRITE;
/*!40000 ALTER TABLE `vaani_crm` DISABLE KEYS */;
/*!40000 ALTER TABLE `vaani_crm` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2022-11-30 10:44:55
